...
class JsonrpcClientUserSettingsService(thryft.web.client.service._jsonrpc_client_service._JsonrpcClientService, yogento.api.services.user_settings.user_settings_service.UserSettingsService):

...
class JsonrpcClientMailService(yogento.api.services.mail.mail_service.MailService):
    @staticmethod
    ...
    def __init__(self, api_url, headers=None):
        yogento.api.services.mail.mail_service.MailService.__init__(self)
    ...
    def _delete_mail_campaign(self, **kwds):
        return self.__request('delete_mail_campaign', **kwds)

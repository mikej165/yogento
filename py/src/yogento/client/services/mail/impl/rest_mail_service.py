...
class RestMailService(thryft.web.service._rest_web_service._RestWebService, yogento.api.services.mail.mail_service.MailService):
    ...
    def _delete_mail_campaign(self, **kwds):
        try:
            self._request('DELETE', '/mail/campaign', data=None, query=thryft.core.protocol.string_map_protocol.StringMapProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None)).to_string_map())
            return True
    ...
    def _get_mail_campaign(self, **kwds):
        __return_value = self._request('GET', '/mail/campaign', data=None, query=thryft.core.protocol.string_map_protocol.StringMapProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None)).to_string_map())
    ...
    def _get_mail_campaigns(self, **kwds):
        __return_value = self._request('GET', '/mail/campaigns', data=None, query=thryft.core.protocol.string_map_protocol.StringMapProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None)).to_string_map())
        iprot = thryft.core.protocol.json_protocol.JsonProtocol(__return_value)
    ...
    def _get_mail_templates(self, **kwds):
        __return_value = self._request('GET', '/mail/templates', data=None, query=thryft.core.protocol.string_map_protocol.StringMapProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None)).to_string_map())
        iprot = thryft.core.protocol.json_protocol.JsonProtocol(__return_value)
    ...
    def _get_mail_template_info(self, **kwds):
        __return_value = self._request('GET', '/mail/template_info', data=None, query=thryft.core.protocol.string_map_protocol.StringMapProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None)).to_string_map())
        iprot = thryft.core.protocol.json_protocol.JsonProtocol(__return_value)
        return yogento.api.models.mail.template.mail_template_info.MailTemplateInfo.read(iprot)

    def _post_mail_campaign(self, **kwds):
        __return_value = self._request('POST', '/mail/campaign', data=str(thryft.core.protocol.json_protocol.JsonProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None))), query=None)
        iprot = thryft.core.protocol.json_protocol.JsonProtocol(__return_value)
        return yogento.api.models.mail.campaign.mail_campaign.MailCampaign.read(iprot)

    def _put_mail_campaign(self, **kwds):
        __return_value = self._request('PUT', '/mail/campaign', data=str(thryft.core.protocol.json_protocol.JsonProtocol().writeMixed(dict((key, value) for key, value in kwds.iteritems() if value is not None))), query=None)
        iprot = thryft.core.protocol.json_protocol.JsonProtocol(__return_value)
        return yogento.api.models.mail.campaign.mail_campaign.MailCampaign.read(iprot)

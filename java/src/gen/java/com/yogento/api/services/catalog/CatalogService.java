...
public interface CatalogService {
    ...
    public String getProductThumbnailUrl(String sku, int thumbnailHeightPx, int thumbnailWidthPx) throws com.yogento.api.services.catalog.NoSuchProductException, com.yogento.api.services.catalog.NoSuchProductImageException;
